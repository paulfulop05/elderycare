...
export type DoctorScalarWhereWithAggregatesInput = {
  ...
  did?: Prisma.IntWithAggregatesFilter<"Doctor"> | number
  ...
  role?: Prisma.BoolWithAggregatesFilter<"Doctor"> | boolean
...
export type DoctorUpdateInput = {
  ...
  role?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type DoctorUncheckedUpdateInput = {
  did?: Prisma.IntFieldUpdateOperationsInput | number
  name?: Prisma.StringFieldUpdateOperationsInput | string
  email?: Prisma.StringFieldUpdateOperationsInput | string
  password?: Prisma.StringFieldUpdateOperationsInput | string
  role?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type DoctorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"did" | "name" | "email" | "password" | "role" | "phoneNumber" | "age", ExtArgs["result"]["doctor"]>
...
export interface DoctorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `did`
   * const doctorWithDidOnly = await prisma.doctor.findMany({ select: { did: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Doctors and only return the `did`
   * const doctorWithDidOnly = await prisma.doctor.createManyAndReturn({
   *   select: { did: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Doctors and only return the `did`
   * const doctorWithDidOnly = await prisma.doctor.updateManyAndReturn({
   *   select: { did: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface DoctorFieldRefs {
  readonly did: Prisma.FieldRef<"Doctor", 'Int'>
  ...
  readonly role: Prisma.FieldRef<"Doctor", 'Boolean'>
