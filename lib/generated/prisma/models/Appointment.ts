...
export type AppointmentWhereInput = {
  ...
  aid?: Prisma.IntFilter<"Appointment"> | number
...
export type AppointmentScalarWhereWithAggregatesInput = {
  ...
  aid?: Prisma.IntWithAggregatesFilter<"Appointment"> | number
...
export type AppointmentUncheckedUpdateInput = {
  aid?: Prisma.IntFieldUpdateOperationsInput | number
  date?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string
  reason?: Prisma.StringFieldUpdateOperationsInput | string
  status?: Prisma.StringFieldUpdateOperationsInput | string
...
export type AppointmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"aid" | "date" | "reason" | "status" | "doctorId" | "patientId", ExtArgs["result"]["appointment"]>
...
export interface AppointmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `aid`
   * const appointmentWithAidOnly = await prisma.appointment.findMany({ select: { aid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Appointments and only return the `aid`
   * const appointmentWithAidOnly = await prisma.appointment.createManyAndReturn({
   *   select: { aid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Appointments and only return the `aid`
   * const appointmentWithAidOnly = await prisma.appointment.updateManyAndReturn({
   *   select: { aid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AppointmentFieldRefs {
  readonly aid: Prisma.FieldRef<"Appointment", 'Int'>
